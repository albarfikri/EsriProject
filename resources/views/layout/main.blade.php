      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {!! request()->is('drainase/*') || request()->is('drainase') ? 'active' : '' !!}" href="/drainase">
                <i class="ni ni-map-big text-primary"></i>
                <span class="nav-link-text">Jaringan Drainase</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link {!! request()->is('tersumbat/*') || request()->is('tersumbat') ? 'active' : '' !!}" href="/tersumbat">
